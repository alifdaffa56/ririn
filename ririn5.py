...
">>>BYE..BYE>><\nJIKA DENDAM CARI KAMI \n<<<<<<<<<>>\nhttps://line.me/ti/p/-ebfwpiU9P")
                        ...
                        elif cmd == "botku" or cmd == "sdbotku":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[RIRIN_BOST].")
                               elapsed_time = time.time() - start
...
#===========KICKOUT============#
                        ...
                        elif cmd == "ririn" or cmd == "sdbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[RIRIN_BOTS].")
                               elapsed_time = time.time() - start
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[RIRIN_BOT].")
                                ki.sendMessage(msg.to, "╚☆STAY☆╗\n╚BOSS╗")
                                kk.sendMessage(msg.to, "╚☆STAY☆╗\n╚BOSS╗")
                                kc.sendMessage(msg.to, "╚☆STAY☆╗\n╚BOSS╗")
